        ...
        $validator->after(function (Validator $validator) {
            ...
            if ($diff > 0.02) {
                $validator->errors()->add(
                    'installments',
                    'A soma das parcelas mais a entrada deve ser igual ao total da venda. Esperado nas parcelas: '.number_format($expected, 2, ',', '.').' (total '.number_format($total, 2, ',', '.').' menos entrada '.number_format($down, 2, ',', '.').').'
                );
            }
        });
    }
