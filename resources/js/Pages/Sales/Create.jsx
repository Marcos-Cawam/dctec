...
export default function SalesCreate({ clients, products, paymentMethods }) {
    const [useInstallments, setUseInstallments] = useState(false);

    const { data, setData, post, processing, errors, transform } = useForm({
        client_id: '',
        payment_method: Object.keys(paymentMethods)[0] || 'pix',
        down_payment: '0',
        items: [{ product_id: products[0]?.id ? String(products[0].id) : '', quantity: '1', unit_price: '' }],
        installments: [],
    });
                                    ...
                                    <div className="space-y-4 rounded border border-amber-200 bg-amber-50/50 p-4 dark:border-amber-900 dark:bg-amber-950/20">
                                        <div>
                                            ...
                                            <p className="mt-1 text-xs text-gray-600 dark:text-gray-400">
                                                ...
                                                . Ao alterar a entrada, use &quot;Recalcular parcelas&quot; para
                                                dividir o restante igualmente entre as parcelas.
                                            </p>
